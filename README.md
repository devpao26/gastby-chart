...
# A chart thats is built on top of react gatsby, node js and chartting library with local json data served.
...
🧐 What's inside?
A quick look at the top-level files and directories you'll see in a Gastby Chart.
...
Note: This project is intended for exam only :)